...
router.post('/', async(req, res, next) => {
    ...
    const deriveKeyFromPassword = async (passwordString, keyTest, saltBuffer, userName, userID, role) => {
    ...
    fetch(varHttpRequest, {
      ...
      .then(async data => {
        ...
        else //Username is at least in the system
        {
            ...
            const {keyresult,saltresult}=await deriveKeyFromPassword(pwTest,userKey,userBuffer,userName,userID,role);
